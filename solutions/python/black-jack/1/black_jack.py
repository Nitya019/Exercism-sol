...
def value_of_ace(card_one, card_two):
    ...
    value_one = new_card(card_one)
    value_two = new_card(card_two)   
...
def is_blackjack(card_one, card_two):
    ...
    value_one = value_of_card(card_one)
    value_two = value_of_card(card_two)
    if (card_one in {"10","K","Q","J"} and card_two =="A") or (card_one == "A" and card_two       in {"10","K","Q","J"}):
        return True
    else:
        return False
